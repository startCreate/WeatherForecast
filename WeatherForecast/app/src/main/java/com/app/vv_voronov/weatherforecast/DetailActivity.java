...
import com.app.vv_voronov.weatherforecast.utilities.DataUtils;
...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String dateText = DataUtils.getFriendlyDateString(this, localDateMidnightGmt, true);

        mDateView.setText(dateText);

        int weatherId = data.getInt(INDEX_WEATHER_CONDITION_ID);
        String description = DataUtils.getStringForWeatherCondition(this, weatherId);

        mDescriptionView.setText(description);

        double highInCelsius = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highString = DataUtils.formatTemperature(this, highInCelsius);

        mHighTemperatureView.setText(highString);

        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = DataUtils.formatTemperature(this, lowInCelsius);
        ...
        String windString = DataUtils.getFormattedWind(this, windSpeed, windDirection);
